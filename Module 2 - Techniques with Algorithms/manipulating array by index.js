/*
	...
	caso a array apresente um número par de elementos, retorne a média entre os dois elementos centrais.5
*/
...
/*
	Create a function called insert(x, lst), which takes a number x and an ordered array of 
	numbers and correctly inserts x at the proper position.
	Ex:
	...
	Crie uma função chamada insere(x, lst), que recebe um número x e uma array ordenada de números 
...
/*
	Create a function called returnPoints(lst), which takes a list of numbers and returns the first and 
	last elements of that list in a new list.
	Ex:
		lst = [2, 3, 5, 7, 8] => Should return [2, 8]
		lst = [ 3 ] => Should return [ 3 ]
		lst = [ ] => Should return [ ]

	Crie uma função chamada retornaPontas(lst), que recebe uma lista de números e 
	retorna o primeiro e o último elemento dessa lista em uma nova lista.
*/
...
/*
	Create a function called removeImpares(lst), which takes a list and returns a 
	new list without the elements of the odd indices of the received list.
	Ex:
		lst = [0, 1, 2, 3, 4, 5] => Should return [0, 2, 4]
		lst = ['yes', 'no', 'yes', 'no', 'yes', 'no',] => Should return ['yes', 'yes', 'yes']


	Crie uma função chamada removeImpares(lst), que recebe uma lista e retorna uma 
	nova lista sem os elementos dos índices ímpares da lista recebida.
*/
